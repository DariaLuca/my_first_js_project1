...
console.log(`${value1} == ${value3} => ${secondCompareResultCompareResult}`);
...
logicalAndResult = falseValue && trueValue;
...
console.log(` !${falseValue} => ${logicalOrResult}`);
